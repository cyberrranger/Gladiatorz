...
if(!empty($_POST["suchen"]))
{
  ...
  $finds = 0;
  $sql = "SELECT * FROM forum_topics WHERE name LIKE '%$suche%'";
...
{
echo"<center>Hier kannst du schauen, ob es Forum Topic mit einem bestimmten Namen gibt ... <br> Vorsicht zeigt alle Ergebnisse an auch welche in fremden Schulforen sind.</center><br>";
  echo"<center><form name=such method=post action=index.php?site=topicsuche>
